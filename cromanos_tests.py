...
class RomanNumberTest(unittest.TestCase):
    ...
    #def tearDown(self):        #borrar el fichero
    ...
    def test_resta_demultiplos_5_NO(self):
    ...
    def test_entero_a_romano(self):
        ...
        self.assertEqual (self.nr.entero_a_romano(2563), 'MMDLXIII')
        self.assertEqual (self.nr.entero_a_romano(1479), 'MCDLXXIX')
